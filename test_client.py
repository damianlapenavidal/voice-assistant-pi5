#!/usr/bin/env python3
"""
Tests for the Pi 5 client's message creation and parsing.
...
def test_hello_message():
    ...
    assert payload["device_type"] == "pi5"
...
def test_make_audio_frame_binary_round_trip():
    """binary=True packs the exact header layout the app's docs/protocol.md
    defines -- byte-identical to what the Zero 2 W client sends, since the app
    decodes both with the same code."""
